...
metadata_gse39055 <- pre_metadata

dim(metadata_gse.39055)
colnames(metadata_gse.39055)
...
identical(colnames(expr_matrix), rownames(metadata_gse.39055))


# TODAVÍA NO TERMINO, PERO LO QUERÍA SUBIR
